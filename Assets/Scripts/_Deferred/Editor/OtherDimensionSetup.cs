...
public class OtherDimensionSetup : Editor
{
    ...
    private static void CreatePlatform(Transform parent)
    {
        ...
        if (renderer != null)
        {
            ...
            mat.color = new Color(0.2f, 0.15f, 0.25f); // Dark purple marble
        ...
        // Remove collider from decorative ring
    ...
    /// <summary>
    /// Creates the central spirit core.
    /// </summary>
    private static void CreateSpiritCore(Transform parent)
    {
        ...
        // Add DimensionalLight component
        spiritCore.AddComponent<DimensionalLight>();

        // Add EpilogueNarrator component
    ...
    /// <summary>
    /// Creates orbiting wisp particles around spirit core.
    /// </summary>
    private static void CreateOrbits(Transform parent)
    {
        for (int i = 0; i < 3; i++)
        {
            ...
            if (renderer != null)
            {
                ...
                {
                    0 => new Color(1f, 0.3f, 0.3f), // Red (terror)
                    1 => new Color(0.3f, 0.3f, 1f), // Blue (unease)
                    _ => new Color(0.3f, 1f, 0.5f)  // Green (neutral)
                };
    ...
    /// <summary>
    /// Creates UI elements for epilogue.
    /// </summary>
    ...
    /// <summary>
    /// Creates post-processing volume.
    /// </summary>
...
/// <summary>
/// Marker component for player spawn location.
/// </summary>
...
/// <summary>
/// Simple orbital motion for wisps.
/// </summary>
